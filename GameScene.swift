...
//
//  Created by Elena on 02.12.2021.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    let staringScrollSpeed: CGFloat = 5.0
    ...
    func startGame() {
        ...
        resetSkater()
        score = 0
        scrollSpeed = staringScrollSpeed
        brickLevel = .low
        lastUpdateTime = nil
    ...
    func updateSkater() {
        if let velocityY = skater.physicsBody?.velocity.dy {
            if velocityY < -100 || velocityY > 100.0 {
    ...
    func updateScore(whithCurrentTime currentTime: TimeInterval) {
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        updateScore(whithCurrentTime: currentTime)
    }
